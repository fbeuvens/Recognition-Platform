...
public class BaseStochasticLevenshteinDigits4 {
	...
	public BaseStochasticLevenshteinDigits4(){
	...
	public void UI(){
		for(int normalisation = 0; normalisation <= 3; normalisation++){
			tw = new TraceWriter("UI2DigitsStochasticLevenshtein4Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinDigits4 bsll = new BaseStochasticLevenshteinDigits4();
		bsll.UI();
