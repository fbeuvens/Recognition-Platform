...
public class BaseStochasticLevenshteinDigits7 {
	...
	public BaseStochasticLevenshteinDigits7(){
	...
	public void UI(){
		for(int normalisation = 3; normalisation <= 3; normalisation++){
			tw = new TraceWriter("UI2DigitsStochasticLevenshtein7Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinDigits7 bsll = new BaseStochasticLevenshteinDigits7();
		bsll.UI();
