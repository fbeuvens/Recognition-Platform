...
public class BaseStochasticLevenshteinDigits5 {
	...
	public BaseStochasticLevenshteinDigits5(){
	...
	public void UI(){
		for(int normalisation = 0; normalisation <= 3; normalisation++){
			tw = new TraceWriter("UI2DigitsStochasticLevenshtein5Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinDigits5 bsll = new BaseStochasticLevenshteinDigits5();
		bsll.UI();
