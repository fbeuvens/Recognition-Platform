...
public class BaseStochasticLevenshteinDigits8 {
	...
	public BaseStochasticLevenshteinDigits8(){
	...
	public void UI(){
		for(int normalisation = 0; normalisation <= 3; normalisation++){
			tw = new TraceWriter("UI2DigitsStochasticLevenshtein8Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinDigits8 bsll = new BaseStochasticLevenshteinDigits8();
		bsll.UI();
