...
public class BaseLevenshteinDigits {
	...
	public static void main(String[] args){
		BaseLevenshteinDigits bll = new BaseLevenshteinDigits();
		bll.UI();
