...
public class BaseStochasticLevenshteinLetters8 {
	...
	public BaseStochasticLevenshteinLetters8(){
	...
	public void UI(){
		for(int normalisation = 0; normalisation <= 0; normalisation++){
			tw = new TraceWriter("UI2LettersStochasticLevenshtein8Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinLetters8 bsll = new BaseStochasticLevenshteinLetters8();
		bsll.UI();
