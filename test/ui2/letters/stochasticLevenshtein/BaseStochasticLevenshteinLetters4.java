...
public class BaseStochasticLevenshteinLetters4 {
	...
	public BaseStochasticLevenshteinLetters4(){
	...
	public void UI(){
		for(int normalisation = 0; normalisation <= 0; normalisation++){
			tw = new TraceWriter("UI2LettersStochasticLevenshtein4Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinLetters4 bsll = new BaseStochasticLevenshteinLetters4();
		bsll.UI();
