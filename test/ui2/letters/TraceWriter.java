...
public class TraceWriter {
	...
	public TraceWriter(String fileName){
		String recover = null;
		try{
			BufferedReader br = new BufferedReader(new FileReader("trace/letters/ui2/"+fileName));
			recover = "";
		...
		try{
			bw = new BufferedWriter(new FileWriter("traces/letters/ui2/"+fileName));
			if(recover != null)
				bw.write(recover);
		}
