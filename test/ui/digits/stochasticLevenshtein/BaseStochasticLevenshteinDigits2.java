...
public class BaseStochasticLevenshteinDigits2 {
	...
	public BaseStochasticLevenshteinDigits2(){
	...
	public void UI(){
		for(int normalisation = 1; normalisation <= 1; normalisation++){
			tw = new TraceWriter("UIDigitsStochasticLevenshtein2Norm"+normalisation+"Test.txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinDigits2 bsll = new BaseStochasticLevenshteinDigits2();
		bsll.UI();
