...
public class BaseStochasticLevenshteinDigits9 {
	...
	public BaseStochasticLevenshteinDigits9(){
	...
	public void UI(){
		for(int normalisation = 1; normalisation <= 1; normalisation++){
			tw = new TraceWriter("UIDigitsStochasticLevenshtein9Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinDigits9 bsll = new BaseStochasticLevenshteinDigits9();
		bsll.UI();
