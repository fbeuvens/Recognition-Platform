...
public class BaseStochasticLevenshteinLetters2 {
	...
	public BaseStochasticLevenshteinLetters2(){
	...
	public void UI(){
		for(int normalisation = 0; normalisation <= 0; normalisation++){
			tw = new TraceWriter("UILettersStochasticLevenshtein2Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinLetters2 bsll = new BaseStochasticLevenshteinLetters2();
		bsll.UI();
