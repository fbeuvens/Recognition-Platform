...
public class BaseStochasticLevenshteinShapes5 {
	...
	public BaseStochasticLevenshteinShapes5(){
	...
	public void UI(){
		for(int normalisation = 0; normalisation <= 3; normalisation++){
			tw = new TraceWriter("UIShapesStochasticLevenshtein5Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinShapes5 bsll = new BaseStochasticLevenshteinShapes5();
		bsll.UI();
