...
public class BaseStochasticLevenshteinShapes7 {
	...
	public BaseStochasticLevenshteinShapes7(){
	...
	public void UI(){
		for(int normalisation = 0; normalisation <= 3; normalisation++){
			tw = new TraceWriter("UIShapesStochasticLevenshtein7Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinShapes7 bsll = new BaseStochasticLevenshteinShapes7();
		bsll.UI();
