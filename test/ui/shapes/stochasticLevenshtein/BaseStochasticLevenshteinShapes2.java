...
public class BaseStochasticLevenshteinShapes2 {
	...
	public BaseStochasticLevenshteinShapes2(){
	...
	public void UI(){
		for(int normalisation = 0; normalisation <= 3; normalisation++){
			tw = new TraceWriter("UIShapesStochasticLevenshtein2Norm"+normalisation+".txt");
			tw.println("-------------------------------------------------- User Dependent -------------------------------------------------");
			tw.println();
			for(int numberTrainingExamples = 2; numberTrainingExamples <= 2; numberTrainingExamples++){
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinShapes2 bsll = new BaseStochasticLevenshteinShapes2();
		bsll.UI();
