...
public class BaseStochasticLevenshteinShapes8 {
	...
	public BaseStochasticLevenshteinShapes8(){
	...
	public void UI(){
		for(int normalisation = 0; normalisation <= 3; normalisation++){
			tw = new TraceWriter("UIShapesStochasticLevenshtein8Norm"+normalisation+".txt");
			tw.println("-------------------------------------------------- User Dependent -------------------------------------------------");
			tw.println();
			for(int numberTrainingExamples = 8; numberTrainingExamples <= 8; numberTrainingExamples++){
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinShapes8 bsll = new BaseStochasticLevenshteinShapes8();
		bsll.UI();
