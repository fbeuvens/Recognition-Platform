...
public class BaseStochasticLevenshteinShapes6 {
	...
	public BaseStochasticLevenshteinShapes6(){
	...
	public void UI(){
		for(int normalisation = 0; normalisation <= 3; normalisation++){
			tw = new TraceWriter("UIShapesStochasticLevenshtein6Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinShapes6 bsll = new BaseStochasticLevenshteinShapes6();
		bsll.UI();
