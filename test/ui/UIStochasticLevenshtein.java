...
public class UIStochasticLevenshtein {
	...
	public UIStochasticLevenshtein(int category, int numberTrainingExamples){
	...
	public void UI(){
		for(int normalisation = 0; normalisation <= 3; normalisation++){
			switch(category){
			case 1: tw = new TraceWriter("digits/ui/UIDigitsStochasticLevenshtein"+numberTrainingExamples+"Norm"+normalisation+".txt");break;
			case 2: tw = new TraceWriter("gestures/ui/UIGesturesStochasticLevenshtein"+numberTrainingExamples+"Norm"+normalisation+".txt");break;
			case 3: tw = new TraceWriter("letters/ui/UILettersStochasticLevenshtein"+numberTrainingExamples+"Norm"+normalisation+".txt");break;
			case 4: tw = new TraceWriter("shapes/ui/UIShapesStochasticLevenshtein"+numberTrainingExamples+"Norm"+normalisation+".txt");break;
			}
	...
	public static void main(String[] args){
		...
		UIStochasticLevenshtein uisl = new UIStochasticLevenshtein(category, numberTrainingExamples);
		uisl.UI();
	}
}
