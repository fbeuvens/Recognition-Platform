...
public class TraceWriter {
	...
	public TraceWriter(String fileName){
		String recover = null;
		try{
			BufferedReader br = new BufferedReader(new FileReader("trace/gestures/ui/"+fileName));
			recover = "";
		...
		try{
			bw = new BufferedWriter(new FileWriter("traces/gestures/ui/"+fileName));
			if(recover != null)
				bw.write(recover);
		}
