...
public class UILevenshtein{
	...
	public UILevenshtein(int category){
		this.category = category;
		confusionMatrixes = new ArrayList<int[][]>();
		strings = new Hashtable<String, String>();
		switch(category){
		case 1: tw = new TraceWriter("digits/ui/UIDigitsLevenshtein.txt");break;
		case 2: tw = new TraceWriter("gestures/ui/UIGesturesLevenshtein.txt");break;
		case 3: tw = new TraceWriter("letters/ui/UILettersLevenshtein.txt");break;
		case 4: tw = new TraceWriter("shapes/ui/UIShapesLevenshtein.txt");break;
		}
	...
	public static void main(String[] args){
		...
		UILevenshtein uil = new UILevenshtein(category);
		uil.UI();
	}
