...
public class TraceWriter {
	...
	public TraceWriter(String fileName){
		String recover = null;
		try{
			BufferedReader br = new BufferedReader(new FileReader("trace/gestures/ud/"+fileName));
			recover = "";
		...
		try{
			bw = new BufferedWriter(new FileWriter("traces/gestures/ud/"+fileName));
			if(recover != null)
				bw.write(recover);
		}
