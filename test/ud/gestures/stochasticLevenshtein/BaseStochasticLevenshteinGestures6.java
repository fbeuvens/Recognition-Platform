...
public class BaseStochasticLevenshteinGestures6 {
	...
	public BaseStochasticLevenshteinGestures6(){
	...
	public void UD(){
		for(int normalisation = 0; normalisation <= 0; normalisation++){
			tw = new TraceWriter("UDGesturesStochasticLevenshtein6Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinGestures6 bsll = new BaseStochasticLevenshteinGestures6();
		bsll.UD();
