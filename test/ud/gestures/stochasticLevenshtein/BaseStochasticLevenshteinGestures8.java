...
public class BaseStochasticLevenshteinGestures8 {
	...
	public BaseStochasticLevenshteinGestures8(){
	...
	public void UD(){
		for(int normalisation = 0; normalisation <= 0; normalisation++){
			tw = new TraceWriter("UDGesturesStochasticLevenshtein8Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinGestures8 bsll = new BaseStochasticLevenshteinGestures8();
		bsll.UD();
