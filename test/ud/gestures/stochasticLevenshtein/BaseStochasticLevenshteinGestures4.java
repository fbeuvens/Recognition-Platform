...
public class BaseStochasticLevenshteinGestures4 {
	...
	public BaseStochasticLevenshteinGestures4(){
	...
	public void UD(){
		for(int normalisation = 0; normalisation <= 0; normalisation++){
			tw = new TraceWriter("UDGesturesStochasticLevenshtein4Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinGestures4 bsll = new BaseStochasticLevenshteinGestures4();
		bsll.UD();
