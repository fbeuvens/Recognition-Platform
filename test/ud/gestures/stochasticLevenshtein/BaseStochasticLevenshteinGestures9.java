package test.ud.gestures.stochasticLevenshtein;
...
public class BaseStochasticLevenshteinGestures9 {
	...
	public BaseStochasticLevenshteinGestures9(){
	...
	public void UD(){
		for(int normalisation = 0; normalisation <= 0; normalisation++){
			tw = new TraceWriter("UDGesturesStochasticLevenshtein9Norm"+normalisation+".txt");
				...
				for(int gestureIndex = 0; gestureIndex < 16; gestureIndex++){
					...
					for(int teIndex = tmp; teIndex != firstTeIndex ; teIndex = (teIndex%10)+1){
						...
						for(int i = 0; i < foundGestures.length; i++){
							String foundDigit = foundGestures[i];
							confusionMatrixes.get(i)[gestureIndex][Utils.gestToInt(foundDigit)]++;
							userConfusionMatrixes.get(i)[gestureIndex][Utils.gestToInt(foundDigit)]++;
						}
						/*if(teIndex == tmp)
							firstTeIndexPassage = false;
						i++;*/
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinGestures9 bsll = new BaseStochasticLevenshteinGestures9();
		bsll.UD();
