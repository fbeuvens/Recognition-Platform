...
public class BaseStochasticLevenshteinGestures5 {
	...
	public BaseStochasticLevenshteinGestures5(){
	...
	public void UD(){
		for(int normalisation = 0; normalisation <= 0; normalisation++){
			tw = new TraceWriter("UDGesturesStochasticLevenshtein5Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinGestures5 bsll = new BaseStochasticLevenshteinGestures5();
		bsll.UD();
