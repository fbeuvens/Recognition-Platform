...
public class BaseStochasticLevenshteinGestures3 {
	...
	public BaseStochasticLevenshteinGestures3(){
	...
	public void UD(){
		for(int normalisation = 0; normalisation <= 0; normalisation++){
			tw = new TraceWriter("UDGesturesStochasticLevenshtein3Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinGestures3 bsll = new BaseStochasticLevenshteinGestures3();
		bsll.UD();
