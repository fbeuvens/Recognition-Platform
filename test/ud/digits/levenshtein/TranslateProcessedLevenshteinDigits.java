...
public class TranslateProcessedLevenshteinDigits {
	...
	public static void main(String[] args){
		TranslateProcessedLevenshteinDigits tpld = new TranslateProcessedLevenshteinDigits();
		tpld.UD();
