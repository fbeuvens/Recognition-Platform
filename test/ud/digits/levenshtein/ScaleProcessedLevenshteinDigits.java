...
public class ScaleProcessedLevenshteinDigits {
	...
	public ScaleProcessedLevenshteinDigits(){
	...
	public static void main(String[] args){
		ScaleProcessedLevenshteinDigits spld = new ScaleProcessedLevenshteinDigits();
		spld.UD();
