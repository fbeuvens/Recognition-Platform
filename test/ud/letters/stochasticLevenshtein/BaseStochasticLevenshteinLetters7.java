...
public class BaseStochasticLevenshteinLetters7 {
	...
	public BaseStochasticLevenshteinLetters7(){
	...
	public void UD(){
		for(int normalisation = 0; normalisation <= 0; normalisation++){
			tw = new TraceWriter("UDLettersStochasticLevenshtein7Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinLetters7 bsll = new BaseStochasticLevenshteinLetters7();
		bsll.UD();
