...
public class BaseStochasticLevenshteinLetters6 {
	...
	public BaseStochasticLevenshteinLetters6(){
	...
	public void UD(){
		for(int normalisation = 0; normalisation <= 0; normalisation++){
			tw = new TraceWriter("UDLettersStochasticLevenshtein6Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinLetters6 bsll = new BaseStochasticLevenshteinLetters6();
		bsll.UD();
