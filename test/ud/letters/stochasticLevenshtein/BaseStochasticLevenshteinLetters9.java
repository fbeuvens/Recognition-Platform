...
public class BaseStochasticLevenshteinLetters9 {
	...
	public BaseStochasticLevenshteinLetters9(){
	...
	public void UD(){
		for(int normalisation = 0; normalisation <= 0; normalisation++){
			tw = new TraceWriter("UDLettersStochasticLevenshtein9Norm"+normalisation+".txt");
	...
	public static void main(String[] args){
		BaseStochasticLevenshteinLetters9 bsll = new BaseStochasticLevenshteinLetters9();
		bsll.UD();
