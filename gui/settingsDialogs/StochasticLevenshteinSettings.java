 ...
 * de Levenshtein stochastique lors de la reconnaissance
 */
public class StochasticLevenshteinSettings extends JPanel {
	...
	public int normalisation, features, knn;
    
    
    public StochasticLevenshteinSettings(JFrame frame) {
    ...
    public StochasticLevenshteinSettings(JFrame frame, JFrame mainFrame) {
        super(new BorderLayout());
        this.frame = frame;
    ...
    private static void createAndShowGUI() {
        JFrame frame = new JFrame("StochasticLevenshtein settings");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        StochasticLevenshteinSettings newContentPane = new StochasticLevenshteinSettings(frame);
